...
namespace PLC_SIEMENS
{
    public partial class ze2 : Form
    {
        ...
        {
            plc.Write("DB7.DBX4.0", true);
        }

        private void close_button_Click(object sender, EventArgs e)
        {
            plc.Write("DB7.DBX44.0", true);
        }

        private void cycle_Tick(object sender, EventArgs e)
        {
            bool bit_open = (bool)plc.Read("DB6.DBX40.3");
            bool bit_close = (bool)plc.Read("DB6.DBX40.4");
            bool bit_awaria = (bool)plc.Read("DB6.DBX40.5");
        ...
        {
            bool bit_alarm1 = (bool)plc.Read("DB1.DBX11.0");
            bool bit_alarm2 = (bool)plc.Read("DB1.DBX11.1");
