...
namespace PLC_SIEMENS
{
    public partial class ze6 : Form
    {
        ...
        {
            plc.Write("DB7.DBX4.4", true);
        }

        private void close_button_Click(object sender, EventArgs e)
        {
            plc.Write("DB7.DBX44.4", true);
        }

        private void cycle_Tick(object sender, EventArgs e)
        {
            bool bit_open = (bool)plc.Read("DB6.DBX42.0");
            bool bit_close = (bool)plc.Read("DB6.DBX42.1");
            bool bit_awaria = (bool)plc.Read("DB6.DBX42.2");
        ...
        {
            bool bit_alarm1 = (bool)plc.Read("DB1.DBX12.0");
            bool bit_alarm2 = (bool)plc.Read("DB1.DBX12.1");
